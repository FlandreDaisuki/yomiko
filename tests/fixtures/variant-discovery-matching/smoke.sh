...
automatic=$(printf '%s' '{"source":{"gid":1,"token":"token-1","title":"Parent","tags":["language:chinese","other:tankoubon"],"first_gid":null,"first_key":null,"parent_gid":null,"parent_key":null,"current_gid":null,"current_key":null},"candidate":{"gid":9,"token":"token-9","title":"Child","tags":["language:chinese","other:tankoubon"],"first_gid":1,"first_key":"token-1","parent_gid":1,"parent_key":"token-1","current_gid":null,"current_key":null}}' | variants_matching_evidence_json)
...
not_automatic=$(printf '%s' '{"source":{"gid":1,"token":"token-1","title":"Parent","tags":["language:chinese","other:tankoubon"],"first_gid":null,"first_key":null,"parent_gid":null,"parent_key":null,"current_gid":null,"current_key":null},"candidate":{"gid":9,"token":"token-9","title":"Child","tags":["language:chinese","other:tankoubon"],"first_gid":1,"first_key":"wrong-token","parent_gid":1,"parent_key":"token-1","current_gid":null,"current_key":null}}' | variants_matching_evidence_json)
