...
def score_variant_members($normalizations):
  ...
  | ([$members[] | .gid | tonumber] | unique) as $canonical_member_gids
  ...
  | {
      scoring_snapshot:[$members[] | {gid:(.gid | tonumber),
        ...
        uploader_revision:.uploader_revision,
        uploader_revision_fingerprint:.uploader_revision_fingerprint,
